...
import app.zengpu.com.myexercisedemo.demolist.design_support_library.activity.DSLLoginActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        demoList.add(new String[]{"Design Support Library ", DSLLoginActivity.class.getName()});
    }
