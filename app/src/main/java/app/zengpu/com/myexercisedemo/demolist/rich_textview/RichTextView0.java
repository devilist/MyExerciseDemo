...
public class RichTextView0 extends TextView {
    ...
    public RichTextView0(Context context) {
        this(context, null);
    }

    public RichTextView0(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RichTextView0(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
