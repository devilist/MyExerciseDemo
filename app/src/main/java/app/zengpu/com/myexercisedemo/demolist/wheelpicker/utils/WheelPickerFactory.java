package app.zengpu.com.myexercisedemo.demolist.wheelpicker.utils;
...
import app.zengpu.com.myexercisedemo.Utils.DateUtil;
import app.zengpu.com.myexercisedemo.Utils.DialogUtil;
import app.zengpu.com.myexercisedemo.demolist.wheelpicker.core.AbstractWheelPicker;
import app.zengpu.com.myexercisedemo.demolist.wheelpicker.view.WheelCurvedPicker;
import app.zengpu.com.myexercisedemo.demolist.wheelpicker.widget.IWheelVo;
import app.zengpu.com.myexercisedemo.demolist.wheelpicker.widget.WheelAAVo;
import app.zengpu.com.myexercisedemo.demolist.wheelpicker.widget.WheelAVo;
import app.zengpu.com.myexercisedemo.demolist.wheelpicker.widget.WheelSimpleVo;
import app.zengpu.com.myexercisedemo.demolist.wheelpicker.widget.WheelSimpleVo2;
...
public class WheelPickerFactory {
     ...
     */
    private static void showWheelAPicker(final View view, final OnWheelClickListener listener,
                                         List<IWheelVo> list, final String unit, int defaultIndex) {
        final AlertDialog alertDialog = DialogUtil.showAlertDialog(view.getContext(),
                R.layout.dialog_wheelpicker_layout_a, true,
                true, true, 0);
    ...
    private static void showWheelAAPicker(final View view, final OnWheelClickListener listener,
        ...
        final AlertDialog alertDialog = DialogUtil.showAlertDialog(view.getContext(),
                R.layout.dialog_wheelpicker_layout_a_a, true,
                true, true, 0);
        final Button mOkBtn = (Button) alertDialog.findViewById(R.id.btn_ok);
        Button mCancelBtn = (Button) alertDialog.findViewById(R.id.btn_cancel);
        // 1级滚轮
    ...
    public static void showWheelBirthdayPicker(final View view, final OnWheelClickListener listener,
        ...
        final AlertDialog alertDialog = DialogUtil.showAlertDialog(view.getContext(),
                R.layout.dialog_wheelpicker_layout_a_a_a, true,
                true, true, 0);
        final Button mOkBtn = (Button) alertDialog.findViewById(R.id.btn_ok);
        Button mCancelBtn = (Button) alertDialog.findViewById(R.id.btn_cancel);
        // 1级滚轮
