package app.zengpu.com.myexercisedemo.tupianlunbo0;
...
public class TuPianLunBoActivity extends AppCompatActivity {
...
//                                ImageHandler.MSG_DELAY);
    ...
    private  static class ImageHandler extends Handler {
         ...
         */
        private WeakReference<TuPianLunBoActivity> weakReference;

        private int currentItem = 0;

        public ImageHandler(WeakReference<TuPianLunBoActivity> wk) {
        ...
        public void handleMessage(Message msg) {
            ...
            TuPianLunBoActivity activity = weakReference.get();
            if (activity == null) {
