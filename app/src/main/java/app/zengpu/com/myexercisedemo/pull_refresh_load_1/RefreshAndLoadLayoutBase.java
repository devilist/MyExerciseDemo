package app.zengpu.com.myexercisedemo.pull_refresh_load_1;
 ...
 */
public class RefreshAndLoadLayoutBase  extends ViewGroup implements
     ...
     * @param context
     */
    public RefreshAndLoadLayoutBase(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public RefreshAndLoadLayoutBase(Context context, AttributeSet attrs) {
     ...
     * @param defStyle
     */
    public RefreshAndLoadLayoutBase(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
